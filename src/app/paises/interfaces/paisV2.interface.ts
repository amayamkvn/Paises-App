// To parse this data:
//
//   import { Convert, RESTCountriesResponse } from "./file";
//
...
export class Convert {
    public static toRESTCountriesResponse(json: string): CountryV2 {
        return cast(JSON.parse(json), r("RESTCountriesResponse"));
    }

    public static rESTCountriesResponseToJson(value: CountryV2): string {
